...
<div class="card dark-card">
    ...
    <div class="card-body">
        <form method="POST"
              action="{{ route('admin.row-datas.update', [$rowData->id]) }}"
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    ...
                    <input class="form-control {{ $errors->has('unique_code') ? 'is-invalid' : '' }}"
                           ...
                           name="unique_code"
                           id="unique_code"
                           value="{{ old('unique_code', $rowData->unique_code) }}"
                           required>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}"
                           ...
                           name="amount"
                           id="amount"
                           value="{{ old('amount', $rowData->amount) }}"
                           required>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input class="form-control date {{ $errors->has('expiry_date') ? 'is-invalid' : '' }}"
                           ...
                           name="expiry_date"
                           id="expiry_date"
                           value="{{ old('expiry_date', $rowData->expiry_date) }}">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}"
                        ...
                        @foreach(App\Models\RowData::STATUS_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('status', $rowData->status) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select class="form-control {{ $errors->has('reward_status') ? 'is-invalid' : '' }}"
                        ...
                        @foreach(App\Models\RowData::REWARD_STATUS_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('reward_status', $rowData->reward_status) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    <input class="form-control {{ $errors->has('used_by') ? 'is-invalid' : '' }}"
                           ...
                           name="used_by"
                           id="used_by"
                           value="{{ old('used_by', $rowData->used_by) }}">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input class="form-control {{ $errors->has('used_by_phone') ? 'is-invalid' : '' }}"
                           ...
                           name="used_by_phone"
                           id="used_by_phone"
                           value="{{ old('used_by_phone', $rowData->used_by_phone) }}">
